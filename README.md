...
- **Music of the desk.** An original, *evolving* electronic score plays beneath the trial — and it never settles. It moves through four phases that keep cycling: **drift** (lush dreamy pads), **pulse** (deep hypnotic Berlin-ish house — a soft round kick, offbeat dub-chord stabs, sidechained "breathing" pads), **lift** (a progressive driving arpeggio), and **ebb** (a breakdown, pads swelling back). And it *reacts*: the pace and brightness climb with your **fervor**, and tension gathers — top-end, chaos, a rising lift — as the **glass empties**. A 16-bar harmony, scheduled against the audio clock, randomized everywhere. Fully synthesised (Web Audio, no files, no samples), with its **own volume** apart from the effects, and toggleable at the desk.
